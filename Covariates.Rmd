...
---
****
#### Covariates are derived from injury narratives with the function '*InjuryCovariates()*'. Code to define, maintain, and extract covariates from narratives is found in the R-script *Large Whale Injury Covariates.R*. Covariates are defined below, followed by example code defining the covariate *decline*, coding it as a presence / absence value, and appending these values to the data.frame 'WhaleData'.
...
# Example code to identify covariate 'decline' from injury narratives in data.frame 'WhaleData'.
