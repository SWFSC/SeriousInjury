...
**WhaleData** is raw data for whale injury cases. Injury descriptions are in the ‘Narrative’ field and assessed health status in the ‘Health.status’ field. Additionally, there is a field ('CAUSE') that attributes the main cause of injury (entanglement = "EN", entrapment = "ET", and vessel strike = "VS"). Entanglements and entrapments are both treated as forms of entanglements for purposes of injury modeling. These 3 fields of type='character' ('Narrative', 'Health.status', and 'CAUSE') are case-sensitive and required to generate injury covariates and build random forest models.
