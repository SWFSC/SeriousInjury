...
##### The data frame *data.test.entangle* includes cases with Health.status="UNKNOWN" and is used with the predict() function and the RF object
'ModelEntangle' to assign each case to "DEAD.DECLINE" or "RECOVERED".
