...
##### Data used in Random Forest (RF) models includes known-outcome cases (Health.status="DEAD.DECLINE" or "RECOVERED"), excluding cases where human intervention to remove entanglements occurred. Model data includes two data frames; *data.entangle* and *data.vessel*, used in RF models.
